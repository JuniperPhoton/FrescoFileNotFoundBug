 ...
 */
public class SampleDynamicDiskStorage implements DiskStorage {
    private static final Class<?> TAG = SampleDynamicDiskStorage.class;
    ...
    @VisibleForTesting
    volatile SampleDynamicDiskStorage.State mCurrentState;
    ...
    public SampleDynamicDiskStorage(
            int version,
        ...
        mCurrentState = new SampleDynamicDiskStorage.State(null, null);
    }
    ...
    private boolean shouldCreateNewStorage() {
        SampleDynamicDiskStorage.State currentState = mCurrentState;
    ...
    private void createStorage() throws IOException {
        ...
        DiskStorage storage = new SampleDiskStorage(rootDirectory, mVersion, mCacheErrorLogger);
        mCurrentState = new SampleDynamicDiskStorage.State(rootDirectory, storage);
    }
